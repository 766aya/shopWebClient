	...
	<div id="goodslist">
		...
		<div id="sidebar" :class="{'is-show': OverLayFlagIsShow}">
			...
			<ul class="price-filter">
				<li><a @click="PFilter('all')" href="javascript:;" :class="{'is-active': priceChecked == 'all'}">所有商品</a></li>
		...
		<div class="container main">
			...
			<div class="rside">
				<a :href="'/Goods/'+item.productId" class="item" v-for="item in GoodsList" :id="'Good'+item.productId">
					<div class="img-box">
		...
		<div class="toggle-page">
			...
			<span><i>第</i><input type="text" v-model="page" @keyup.enter="getGoodsList"><i>页</i></span>
...
<script>
	export default {
		...
		methods: {
			...
			onPage() {
				if((this.page == 1 && this.page == this.maxpage) || this.maxpage == 0) {
					console.log('1')
					this.disPrev = true;
					this.disNext = true;
				}else if (this.page <= 1) {
